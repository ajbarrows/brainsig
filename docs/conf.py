#
# brainsig documentation build configuration file
#
...
project = "brainsig"
copyright = "Copyright © 2025 Tony Barrows"
...
# built documents.
try:
    version = importlib.metadata.version("brainsig")
...
htmlhelp_basename = "brainsig_doc"
